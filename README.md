...
<p align="center" float="middle">
  <a href="./assets/pointnet_architecture_02_horizontal.png">
    <img width="100.0%" src="./assets/pointnet_architecture_02_horizontal.png"/>
  </a>
  <em>Illustration of the end-to-end actor-critic network architecture with PointNet-based 3D feature extractor.</em>
</p>
<p align="center" float="middle">
  <a href="./assets/DP3_architecture_horizontal.png">
    <img width="100.0%" src="./assets/DP3_architecture_horizontal.png"/>
  </a>
